...
<head>
    ...
    <title>Editar Paciente — Sistema Dental</title>
...
<div class="flex min-h-screen">
    ...
    <main class="ml-64 flex-1 p-8">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Editar Paciente</h2>
                <p class="text-slate-500 text-sm mt-1">Actualiza la información de {{ $patient->first_name }} {{ $patient->last_name }}</p>
            </div>
        </div>
            ...
            <div class="grid grid-cols-3 gap-6">
                ...
                <div class="col-span-1 space-y-6">
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm p-6 flex flex-col items-center text-center">
                        ...
                        <p class="text-slate-700 font-bold text-lg" id="name-preview">{{ $patient->first_name }} {{ $patient->last_name }}</p>
                        <p class="text-slate-400 text-sm mt-1">CI: {{ $patient->CI }}</p>
                    </div>
