...
<head>
    ...
    <title>Nuevo Historial — Sistema Dental</title>
...
<div class="flex min-h-screen">
    ...
    <main class="ml-64 flex-1 p-8">
        ...
        <div class="flex items-center gap-4 mb-8">
            ...
            <div>
                <h2 class="text-2xl font-bold text-slate-800">Nuevo Historial Médico</h2>
                    ...
                    <div class="bg-white rounded-2xl border border-slate-100 shadow-sm overflow-hidden">
                        <div class="gradient-header px-6 py-5">
                            <div class="flex items-center gap-3">
                                ...
                                <div>
                                    <p class="text-white font-bold text-sm">{{ $patient->first_name }} {{ $patient->last_name }}</p>
                                    <p class="text-teal-200 text-xs">CI: {{ $patient->CI }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="px-6 py-4 space-y-2">
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xs font-semibold text-slate-700">{{ $patient->phone_number ?? '—' }}</span>
                            </div>
                            <div class="flex items-center justify-between">
                            ...
                            <div class="flex items-center justify-between">
                                ...
                                <span class="text-xs font-semibold text-slate-700">{{ $patient->sex ?? '—' }}</span>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea name="previous_diseases" rows="3"
                                    ...
                                    class="input-field resize-none">{{ old('previous_diseases') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="current_medications" rows="3"
                                    ...
                                    class="input-field resize-none">{{ old('current_medications') }}</textarea>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            <div>
                                ...
                                <textarea name="reason_for_visit" rows="3"
                                    ...
                                    class="input-field resize-none" required>{{ old('reason_for_visit') }}</textarea>
                            </div>
                            <div>
                                ...
                                <textarea name="diagnosis" rows="3"
                                    ...
                                    class="input-field resize-none">{{ old('diagnosis') }}</textarea>
                            </div>
                        </div>
                    </div>
